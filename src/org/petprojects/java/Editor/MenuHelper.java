...
import org.petprojects.java.Editor.actions.*;
import org.petprojects.java.Editor.listeners.TextEditMenuListener;
import org.petprojects.java.Editor.listeners.UndoMenuListener;
...
public class MenuHelper {
    ...
    public static void initAlignMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("Centre", StyleConstants.ALIGN_CENTER));
