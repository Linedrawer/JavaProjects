...
public class ZipFileManager {
    ...
    public void createZip(Path source) throws Exception {
        //Check whether directory is there where we want to create archive, if not create it
        ...
        try (ZipOutputStream zipOutputStream = new ZipOutputStream(Files.newOutputStream(zipFile))) {
            ...
            if (Files.isDirectory(source)) {
                // If archiving directory, we need to get list of files in it
                ...
                // If separate file goes to archive, get its directory and name
                addNewZipEntry(zipOutputStream, source.getParent(), source.getFileName());
            } else {

                // In case source is not directory or file, throw exception
    ...
    public List<FileProperties> getFilesList() throws Exception {
        ...
        try (ZipInputStream zipInputStream = new ZipInputStream(Files.newInputStream(zipFile))) {
            ...
            while (zipEntry != null) {
                //Fields 'size' and 'compressedSize' is unknown until element is read
                //we shall read it in another stream
